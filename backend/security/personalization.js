/**
 * Security hardening: personalization
 * Task: Run security hardening pass for personalization: secret rotation, dependency rev
 */
'use strict';

/**
 * Secret rotation checklist for personalization:
