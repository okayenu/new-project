/**
 * Analytics event instrumentation: search-and-discovery
 * Task: Instrument analytics for search and discovery interactions: upload success, shuf
 */
'use strict';

const EVENT_PREFIX = 'SEARCH_AND_DISCOVERY';
...
/**
 * Normalize event payload to ensure consistent shape across all search-and-discovery events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:search-and-discovery]', JSON.stringify(payload));
  }
}
