/**
 * Analytics event instrumentation: community-experiences-assistant-quality
 * Task: Instrument analytics for community experiences assistant quality: helpfulness vo
 */
'use strict';

const EVENT_PREFIX = 'COMMUNITY_EXPERIENCES_ASSISTANT_QUALITY';
...
/**
 * Normalize event payload to ensure consistent shape across all community-experiences-assistant-quality events.
...
function normalizePayload(type, data = {}) {
  return {
    ...
    properties: {
      ...data,
      source: 'community-experiences-assistant-quality',
    },
  };
}
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:community-experiences-assistant-quality]', JSON.stringify(payload));
  }
}
