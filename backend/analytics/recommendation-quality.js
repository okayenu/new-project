...
const EVENT_PREFIX = 'RECOMMENDATION_QUALITY';
...
/**
 * Normalize event payload to ensure consistent shape across all recommendation-quality events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:recommendation-quality]', JSON.stringify(payload));
  }
}
