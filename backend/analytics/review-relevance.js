...
const EVENT_PREFIX = 'REVIEW_RELEVANCE';
...
/**
 * Normalize event payload to ensure consistent shape across all review-relevance events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:review-relevance]', JSON.stringify(payload));
  }
}
