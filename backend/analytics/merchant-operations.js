...
const EVENT_PREFIX = 'MERCHANT_OPERATIONS';
...
/**
 * Normalize event payload to ensure consistent shape across all merchant-operations events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:merchant-operations]', JSON.stringify(payload));
  }
}
