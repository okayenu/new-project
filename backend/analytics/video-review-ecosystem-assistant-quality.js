/**
 * Analytics event instrumentation: video-review-ecosystem-assistant-quality
 * Task: Instrument analytics for video review ecosystem assistant quality: helpfulness v
 */
'use strict';

const EVENT_PREFIX = 'VIDEO_REVIEW_ECOSYSTEM_ASSISTANT_QUALITY';
...
/**
 * Normalize event payload to ensure consistent shape across all video-review-ecosystem-assistant-quality events.
...
function normalizePayload(type, data = {}) {
  return {
    ...
    properties: {
      ...data,
      source: 'video-review-ecosystem-assistant-quality',
    },
  };
}
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:video-review-ecosystem-assistant-quality]', JSON.stringify(payload));
  }
}
