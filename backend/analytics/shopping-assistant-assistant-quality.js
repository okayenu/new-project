/**
 * Analytics event instrumentation: shopping-assistant-assistant-quality
 * Task: Instrument analytics for shopping assistant assistant quality: helpfulness votes
 */
'use strict';

const EVENT_PREFIX = 'SHOPPING_ASSISTANT_ASSISTANT_QUALITY';
...
/**
 * Normalize event payload to ensure consistent shape across all shopping-assistant-assistant-quality events.
...
function normalizePayload(type, data = {}) {
  return {
    ...
    properties: {
      ...data,
      source: 'shopping-assistant-assistant-quality',
    },
  };
}
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:shopping-assistant-assistant-quality]', JSON.stringify(payload));
  }
}
