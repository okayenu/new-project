...
const EVENT_PREFIX = 'CHECKOUT_ORCHESTRATION';
...
/**
 * Normalize event payload to ensure consistent shape across all checkout-orchestration events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:checkout-orchestration]', JSON.stringify(payload));
  }
}
