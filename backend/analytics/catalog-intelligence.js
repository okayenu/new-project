...
const EVENT_PREFIX = 'CATALOG_INTELLIGENCE';
...
/**
 * Normalize event payload to ensure consistent shape across all catalog-intelligence events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:catalog-intelligence]', JSON.stringify(payload));
  }
}
