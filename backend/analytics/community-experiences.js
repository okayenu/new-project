...
const EVENT_PREFIX = 'COMMUNITY_EXPERIENCES';
...
/**
 * Normalize event payload to ensure consistent shape across all community-experiences events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:community-experiences]', JSON.stringify(payload));
  }
}
