...
const EVENT_PREFIX = 'SHOPPING_ASSISTANT';
...
/**
 * Normalize event payload to ensure consistent shape across all shopping-assistant events.
...
function dispatchEvent(payload) {
  ...
  if (typeof process !== 'undefined' && process.env.NODE_ENV !== 'test') {
    console.info('[analytics:shopping-assistant]', JSON.stringify(payload));
  }
}
