/**
 * Shared utilities: merchant-operations
 * Task: Run refactor pass: extract shared utilities for merchant operations formatting, 
 */
'use strict';

/**
 * Format a merchant-operations item for API responses.
...
function mapResponseShape(item) {
  return {
    ...formatItem(item),
    _links: {
      self: `/api/merchant-operations/${item.id}`,
      collection: `/api/merchant-operations`,
    },
  };
}
