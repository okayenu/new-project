/**
 * Repository layer: 3d-product-rendering
 * Task: Add repository layer methods for 3D product rendering queries with index strateg
 *
 * Index strategy:
...
class 3dProductRenderingRepository {
  constructor(db) {
    this.db = db;
    this.table = '3d_product_rendering';
  }
...
module.exports = { 3dProductRenderingRepository };
