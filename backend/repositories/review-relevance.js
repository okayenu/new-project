/**
 * Repository layer: review-relevance
 * Task: Add repository layer methods for review relevance queries with index strategy co
 *
 * Index strategy:
...
class ReviewRelevanceRepository {
  constructor(db) {
    this.db = db;
    this.table = 'review_relevance';
  }
...
module.exports = { ReviewRelevanceRepository };
