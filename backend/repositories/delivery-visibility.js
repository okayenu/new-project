/**
 * Repository layer: delivery-visibility
 * Task: Add repository layer methods for delivery visibility queries with index strategy
 *
 * Index strategy:
...
class DeliveryVisibilityRepository {
  constructor(db) {
    this.db = db;
    this.table = 'delivery_visibility';
  }
...
module.exports = { DeliveryVisibilityRepository };
